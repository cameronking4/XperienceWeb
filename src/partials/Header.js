        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            ...
            <Link to="/" className="block" aria-label="Cruip">
              ...
              <img className="object-cover" src={require('../images/logo.png')} width="290" alt="Tabs 01" />
            </Link>
          </div>
          ...
          <nav className="hidden md:flex md:flex-grow">
            ...
            {/* <li>
              ...
              <Dropdown title="Support">
                ...
                <li>
                  <Link to="/help" className="font-medium text-sm text-gray-400 hover:text-purple-600 flex py-2 px-4 leading-tight">FAQs</Link>
                </li>
                {/* <li>
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <Link to="/signin" className="font-medium text-teal-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">Sign in</Link>
              </li>
              <li>
                <Link to="/signup" className="btn-sm text-white bg-teal-600 hover:bg-purple-700 ml-3">Sign up</Link>
              </li>
            </ul>
            ...
            <nav id="mobile-nav" ref={mobileNav} className="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" style={mobileNavOpen ? { maxHeight: mobileNav.current.scrollHeight, opacity: 1 } : { maxHeight: 0, opacity: .8 } }>
              <ul className="bg-gray-800 px-4 py-2">
                ...
                <li className="py-2 my-2 border-t border-b border-gray-700">
                  <Link to="/help" className="flex text-gray-300 py-2">Support</Link>
                  <ul className="pl-4">
                    <li>
                      <Link to="/contact" className="text-sm flex font-medium text-gray-400 hover:text-gray-200 py-2">Contact us</Link>
                    </li>
                    <li>
                      <Link to="/help" className="text-sm flex font-medium text-gray-400 hover:text-gray-200 py-2">FAQs</Link>
                    </li>
                    {/* <li>
                ...
                <li>
                  <Link to="/signin" className="flex font-medium w-full text-teal-600 hover:text-gray-200 py-2 justify-center">Sign in</Link>
                </li>
                <li>
                  <Link to="/signup" className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-white bg-teal-600 hover:bg-teal-700 transition duration-150 ease-in-out">Sign up</Link>
                </li>
              </ul>
            </nav>
