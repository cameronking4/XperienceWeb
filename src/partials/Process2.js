      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4" data-aos="fade-up">How Can I Help?</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200"> In addition to saving the planet, our software promotes body positivity. You can help us ensure the perfect fit by contributing to our traing data; this will allow for a diverse and inclusive range of body sizes to make our algorithms even more accurate.</p>
          </div>
        ...
        {/* Image */}
        <img className="mx-auto" src={require('../images/Screens/personalized.png')} width="1080" height="432" alt="Hero" data-aos="fade-up" data-aos-delay="400" />
      </div>
    </section>
  );
}
