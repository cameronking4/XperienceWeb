        ...
        <section className="relative">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              {/* Page header */}
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16" id="top">
                <h1 className="h1 mb-4" data-aos="fade-up">We're here to help!</h1>
                <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">We have plans to power your business. Tell us your needs, and we’ll contact you shortly.</p>
              </div>
