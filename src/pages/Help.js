            ...
            <div className="flex flex-col md:flex-row">
              ...
              <main className="md:flex-auto md:pl-10 order-1" data-aos="fade-up">
                ...
                <div className={page !== 1 ? 'hidden' : undefined}>
                  ...
                  <ul className="-my-4">
                    <li className="py-4">
                      <h4 className="text-xl font-medium mb-2">How can I use Xperience Shopping without registration?</h4>
                    ...
                    <li className="py-4">
                      <h4 className="text-xl font-medium mb-2">Can I import my sitemap to Xperience Shopping?</h4>
                      <p className="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum.</p>
                    </li>
                    <li className="py-4">
                ...
                <nav>
                  <ul>
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-teal-600 transition duration-150 ease-in-out ${page === 1 && 'text-teal-600'}`}
                        href="#0"
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-teal-600 transition duration-150 ease-in-out ${page === 2 && 'text-teal-600'}`}
                        href="#0"
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-teal-600 transition duration-150 ease-in-out ${page === 3 && 'text-teal-600'}`}
                        href="#0"
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-teal-600 transition duration-150 ease-in-out ${page === 4 && 'text-teal-600'}`}
                        href="#0"
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-teal-600 transition duration-150 ease-in-out ${page === 5 && 'text-teal-600'}`}
                        href="#0"
